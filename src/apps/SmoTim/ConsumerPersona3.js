...
const ConsumerPersona = () => {
    ...
    // Handle Change with a Character Limit
    const charLimit = 300;
    ...
    // Validate Form by Character Count
    const validateForm = () => {
        const errors = {};
            ...
            while (true) {
                ...
                for (let i = 0; i < lines.length - 1; i++) {
                    ...
                    if (line.startsWith("data: ")) {
                        ...
                        if (dataStr === "") continue; // Ignore empty data

                        try {
                            const data = JSON.parse(dataStr);

                            if (data.error) {
                                setFieldErrors({ global: data.error });
                                setLoading(false);
                                reader.cancel();
                                return;
                            }
                            ...
                            if (data.imageUrl) {
                                // Final persona data with image URL
                                setPersona((prev) => ({ ...prev, imageUrl: data.imageUrl }));
                                ...
                                // Intermediate persona data chunks
        ...
        <div className="min-h-full bg-gradient-to-br from-indigo-50 to-purple-50 p-4">
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    <div className="bg-white p-6 shadow-md rounded-lg border border-gray-200">
                        ...
                        <textarea
                            ...
                            className={`w-full border rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all ${fieldErrors.brandName ? "border-red-500" : "border-gray-300"
                                }`}
                    ...
                    <div className="bg-white p-6 shadow-md rounded-lg border border-gray-200">
                        ...
                        <textarea
                            ...
                            onChange={handleChange}
                            className={`w-full border rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all ${fieldErrors.brandDescription ? "border-red-500" : "border-gray-300"
                                }`}
                ...
                <button
                    ...
                    className={`w-full p-3 rounded-lg transition-all shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 ${loading || hasSubmitted
